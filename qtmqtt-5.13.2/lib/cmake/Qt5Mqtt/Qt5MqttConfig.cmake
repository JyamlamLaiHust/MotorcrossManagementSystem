...
set(Qt5Mqtt_VERSION_STRING 5.13.2)
...
if (NOT TARGET Qt5::Mqtt)
    ...
    foreach(_module_dep ${_Qt5Mqtt_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.13.2 ${_Qt5Mqtt_FIND_VERSION_EXACT}
    ...
    _populate_Mqtt_target_properties(RELEASE "Qt5Mqtt.dll" "libQt5Mqtt.a" TRUE)



    _populate_Mqtt_target_properties(DEBUG "Qt5Mqttd.dll" "libQt5Mqttd.a" TRUE)
