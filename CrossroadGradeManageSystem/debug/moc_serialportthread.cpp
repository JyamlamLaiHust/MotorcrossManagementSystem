...
void SerialPortThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SerialPortThread *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (SerialPortThread::*)(char * , int );
        ...
        {
            using _t = void (SerialPortThread::*)(QByteArray );
        ...
        {
            using _t = void (SerialPortThread::*)(QString );
        ...
        {
            using _t = void (SerialPortThread::*)();
...
QT_INIT_METAOBJECT const QMetaObject SerialPortThread::staticMetaObject = { {
    &QThread::staticMetaObject,
    qt_meta_stringdata_SerialPortThread.data,
    qt_meta_data_SerialPortThread,
    qt_static_metacall,
    nullptr,
    nullptr
} };
