...
#include "../../CrossroadGradeManageSystem/pages/exitgames/exitgames.h"
...
void ExitGames::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ExitGames *_t = static_cast<ExitGames *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject ExitGames::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ExitGames.data,
      qt_meta_data_ExitGames,  qt_static_metacall, nullptr, nullptr}
};
